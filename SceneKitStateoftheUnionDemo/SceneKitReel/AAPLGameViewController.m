...
//    0_2707.DAE
    ...
    SCNScene *testScene = [SCNScene sceneNamed:@"0_2707.DAE" inDirectory:@"assets.scnassets/models/DAE" options:nil];
    SCNNode *testModel = [testScene.rootNode childNodeWithName:@"model" recursively:YES];
    
//    testModel.geometry.firstMaterial.emission.contents = testModel.geometry.firstMaterial.diffuse.contents;
//    testModel.geometry.firstMaterial.emission.intensity = 0.5;
    
    testModel.scale = SCNVector3Make(0.02, 0.02, 0.02);
    
    testModel.position =  SCNVector3Make(200, 0, position.z + 50);
    
//    [_scene.rootNode addChildNode:testModel];
  ...
  //   _shipNode.rotation = SCNVector4Make(0, 1, 0,M_PI_4*0.5);
    ...
    node.position =  SCNVector3Make(200, 10, position.z + 50);
    node.eulerAngles = SCNVector3Make(M_PI/2, M_PI/2, 0);
